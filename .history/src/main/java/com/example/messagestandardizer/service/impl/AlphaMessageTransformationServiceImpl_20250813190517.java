...
/**
 * Message transformation implementation for Alpha provider.
 *
 * Author: Yash Londhe
...
public class AlphaMessageTransformationServiceImpl implements MessageTransformationService {
    ...
    @Override
    /**
     * Transform an Alpha-specific message to a standard message.
     *
     * @param message Alpha provider message
    ...
    /**
     * Transform Alpha odds message to standard odds message.
     *
     * @param alphaMessage Alpha odds message
    ...
    /**
     * Transform Alpha settlement message to standard settlement message.
     *
     * @param alphaMessage Alpha settlement message
