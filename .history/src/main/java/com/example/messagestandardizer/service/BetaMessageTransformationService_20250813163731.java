...
@Service
@Slf4j
public class BetaMessageTransformationService implements MessageTransformationServiceInterface<BetaMessage> {
    
    @Override
    public StandardMessage transform(BetaMessage message) {
    ...
    private StandardOddsMessage transformOdds(BetaOddsMessage betaMessage) {
        ...
        standardMessage.setClientMessageId(betaMessage.getEventId());
