...
/**
 * Controller for Alpha provider message ingestion.
 *
 * Author: Yash Londhe
...
public class ProviderAlphaController {
    ...
    public ResponseEntity<StandardResponse> processFeed(@RequestBody AlphaMessage alphaMessage) {
        try {
            ...
            String eventId = alphaMessage.getEventId();
            return ResponseEntity.ok(MiscUtils.getOkResponse( "Alpha message processed successfully for event: " + eventId));
