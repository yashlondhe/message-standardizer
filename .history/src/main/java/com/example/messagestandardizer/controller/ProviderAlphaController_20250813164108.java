...
public class ProviderAlphaController {
    ...
    @Autowired
    private MessageTransformationServiceFactory transformationServiceFactory;
    ...
    public ResponseEntity<StandardResponse> processFeed(@RequestBody AlphaMessage alphaMessage) {
        try {
            MessageTransformationServiceInterface<?> transformationService = transformationServiceFactory
                .getTransformationService("alpha");
            
            StandardMessage standardMessage = ((MessageTransformationServiceInterface<AlphaMessage>) transformationService)
